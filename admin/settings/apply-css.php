...
* Logo href
*/
if ( !function_exists('bobs_custom_url_login')) {
    function bobs_custom_url_login()  {
        return get_bloginfo( 'url' );
    }
    add_filter('login_headerurl', 'bobs_custom_url_login');
}

/**
* HEX to RGBA
*/
if ( !function_exists('bobs_hex2rgba')) {
    function bobs_hex2rgba($color, $opacity = false) {
...
* Darken/Lighten HEX
*/
if ( !function_exists('bobs_color_creator')) {
    function bobs_color_creator($color, $per)
    {
...
* Preview
*/
add_action('admin_head', 'bobs_apply_preview_css');
function bobs_apply_preview_css() {
    ...
    if ($logo_id != '') {
        ...
        $logo = plugins_url() . '/bobs-custom-login/admin/images/w-logo-blue.png' ;
        $logo_width = '84' ;
        $logo_height = '84' ;
    }
    ...
    $rgba_06 = bobs_hex2rgba($bcl_form_button_color, 0.6);
    $darkPercent = -13;
    $lightPercent = 90;
    $darker = bobs_color_creator($bcl_form_button_color, $darkPercent);
    $lighter = bobs_color_creator($bcl_form_button_color, $lightPercent);
    $rgba_015 = bobs_hex2rgba($lighter, 0.15);
...
* Login Screen
*/
add_action( 'login_enqueue_scripts', 'bobs_custom_login_css' );
function bobs_custom_login_css() {

...
$text_domain = 'bobs-custom-login';
$logo = plugin_dir_url( dirname( dirname( __FILE__ ) ) ) . 'admin/images/w-logo-blue.png';
$icon = plugin_dir_url( dirname( dirname( __FILE__ ) ) ) . 'admin/images/bobs.png';
$blog_name = get_bloginfo('name');
$blog_url = get_bloginfo('url');

// Top level page & First Section
$bobs_custom_login_top_page = create_settings_page(
    'bobs_custom_login_settings',
    '<img src="'.$icon.'"> '.__('Custom Login Settings', $text_domain),
    array(
            'parent' => 'themes.php',
            'title' => __('bobs Custom Login', $text_domain),
...
// Other Sections
$bobs_custom_login_top_page->apply_settings( array(
    ...
    'bcl_notice_section'    => array(
        'title'  => __( 'HI', $text_domain ),
        'fields' => array(
            'bcl_notice' => array(
                'type'    => 'preview',
                'label'   => __( 'WAZZUP', $text_domain ),
                'description' => '

                    <div class="molly postbox">
                        <div class="inside">
                        <p>'.__( 'Just a message from the creator', $text_domain ).'</p>
                        <p>&nbsp;</p>
                        <p>'.__( 'I wanted to say to everyone who downloaded this plugin a HUGE THANKYOU for supporting me, and please visit my website with the button below', $text_domain ).'
                        
                        <p><a href="http://www.travis.ga" class="button-primary" target="_blank">'.__( 'Visit My Site', $text_domain ).'</a></p>
                        </div>
                    </div>
                ', // End HI
            )
